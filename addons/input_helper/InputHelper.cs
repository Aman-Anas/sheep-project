...
namespace NathanHoad
{
    public partial class InputHelper : Node
    {
                    ...
                    instance.Connect(
                        ...
                        Callable.From(
                            (string action, InputEvent input) =>
                                KeyboardInputChanged?.Invoke(action, input)
                        )
                    );
                    instance.Connect(
                        "joypad_input_changed",
                        Callable.From(
                            (string action, InputEvent input) =>
                                JoypadInputChanged?.Invoke(action, input)
                        )
                    );
                    instance.Connect(
                        "joypad_changed",
                        Callable.From(
                            (int deviceIndex, bool isConnected) =>
                                JoypadChanged?.Invoke(deviceIndex, isConnected)
                        )
                    );
                }
                return instance;
        ...
        public static void SetKeyboardOrJoypadInputForAction(
            string action,
            InputEvent input,
            bool swapIfTaken = true
        )
        {
            Instance.Call("set_keyboard_or_joypad_input_for_action", action, input, swapIfTaken);
        }

        public static InputEvent GetKeyboardOrJoypadInputForAction(
            string action,
            InputEvent input,
            bool swapIfTaken = true
        )
        {
            return (InputEvent)
                Instance.Call(
                    "get_keyboard_or_joypad_input_for_action",
                    action,
                    input,
                    swapIfTaken
                );
        ...
        public static Array<InputEvent> GetKeyboardOrJoypadInputsForAction(string action)
        {
            return (Array<InputEvent>)
                Instance.Call("get_keyboard_or_joypad_inputs_for_action", action);
        }
        ...
        public static void SetKeyboardInputForAction(
            string action,
            InputEvent input,
            bool swapIfTaken = true
        )
        ...
        public static void ReplaceKeyboardInputForAction(
            string action,
        ...
        {
            Instance.Call(
                "replace_keyboard_input_for_action",
                action,
                currentInput,
                input,
                swapIfTaken
        ...
        public static void ReplaceKeyboardInputAtIndex(
            string action,
            int index,
            InputEvent input,
            bool swapIfTaken = true
        ...
        public static void SetJoypadInputForAction(
            string action,
            InputEvent input,
            bool swapIfTaken = true
        )
        ...
        public static void ReplaceJoypadInputForAction(
            string action,
            InputEvent currentInput,
            InputEvent input,
            bool swapIfTaken = true
        ...
        {
            Instance.Call(
                "replace_joypad_input_for_action",
                action,
                currentInput,
                input,
                swapIfTaken
        ...
        public static void ReplaceJoypadInputAtIndex(
            string action,
            int index,
            InputEvent input,
            bool swapIfTaken = true
